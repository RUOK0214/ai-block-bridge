...
public final class RecordingOptionsScreen extends Screen {
    ...
    private Button entities,noise,cooldown,delta,ids;
    ...
    @Override protected void init(){
        ...
        delta=toggle("ai_block_bridge.record_options.delta","ai_block_bridge.record_options.delta_hint",124,()->BridgeClient.entityDelta,()->BridgeClient.entityDelta=!BridgeClient.entityDelta);
        ids=toggle("ai_block_bridge.record_options.ids","ai_block_bridge.record_options.ids_hint",152,()->BridgeClient.shortEntityIds,()->BridgeClient.shortEntityIds=!BridgeClient.shortEntityIds);
    ...
    @Override public void tick(){
        ...
        entities.active=idle;noise.active=idle&&BridgeClient.includeTimelineEntities;cooldown.active=idle;delta.active=noise.active;ids.active=noise.active;
    }
